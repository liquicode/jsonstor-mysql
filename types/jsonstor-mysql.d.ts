// Type declarations for @liquicode/jsonstor-mysql
//
...
declare module '@liquicode/jsonstor-mysql'
{
	...
	{
		/** The name or address of the MySql server. Defaults to `"localhost"`. */
		Server?: string;
		/** The service port of the MySql server. Defaults to `3306`. */
		Port?: number;
		...
		/** Encrypt the connection with TLS. Off by default so that a local server connects; a hosted MySQL requires it on. Defaults to `false`. */
		Encrypt?: boolean;
	...
	{
		/** `'jsonstor-mysql'`. The package's bare name, which `Aliases` maps onto a prime. */
		AdapterName: string;
	...
	//---------------------------------------------------------------------
	// Named exports, matching src/jsonstor-mysql.mjs one for one.
